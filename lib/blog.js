...
router.get('/disclaimer', function(req) {
    return helper.config().then (function (locals) {
        locals['siteTitle'] = locals['title']+" | Disclaimer";
  ...
  return couchdb.get(req.params.id).then(function(post) {
    ...
    return helper.config().then(function(config) {
        ...
        return helper.counts().then(function(counts) {
            ...
            return viewEngine.respond('post.html', {locals:locals,partials:{'post':'post.partial.html'}});
            }, function (err) {
                return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
            });
        }, function (err) {
...
router.get('/admin', function(req) {
    locals = {"adminSubtitle":"Overview"};
    return helper.readFile('README').then(function (data) {
        locals = {"adminSubtitle":"Overview","readme":data};
...
router.get('/admin/config/settings', function(req) {
    return helper.config().then (function (config) {
        locals = {"adminSubtitle":"Blog configuration","config":config};
        return viewEngine.respond('admin_config_settings.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_config':'admin_config.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/config/css', function(req) {
    return helper.config().then (function (config) {
        locals = {"adminSubtitle":"Blog configuration","config":config};
        return viewEngine.respond('admin_config_css.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_config':'admin_config.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/config/disclaimer', function(req) {
    return helper.config().then (function (config) {
        locals = {"adminSubtitle":"Blog configuration","config":config};
        return viewEngine.respond('admin_config_disclaimer.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_config':'admin_config.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/config/images', function(req) {
    locals = {"adminSubtitle":"Blog configuration"};
    return viewEngine.respond('admin_config_images.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_config':'admin_config.partial.html'}});
});
...
router.get('/admin/config/extra', function(req) {
    return helper.config().then (function (config) {
        ...
        for (var name in config['_attachments']) {
            if (name != 'background.jpg' && name != 'favicon.ico' && name != 'titleImage.png') {
                images.push({'name':name});
            }
        }
        locals = {"adminSubtitle":"Blog configuration","images":images};
        return viewEngine.respond('admin_config_extra.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_config':'admin_config.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/posts', function(req) {
    return helper.config().then (function (config) {
        return couchdb.view('blog/all_posts_by_date',{'descending':true}).then(function(res) {
            ...
            locals = {"adminSubtitle":"Manage posts","posts":posts,"disqus_shortname":config['disqus_shortname']};
...
router.get('/admin/post/:id/settings', function(req) {
  return couchdb.get(req.params.id).then(function(post) {
    locals = {"adminSubtitle":"Manage post","post":post};

    return viewEngine.respond('admin_post_settings.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_post':'admin_post.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/post/:id/images', function(req) {
  return couchdb.get(req.params.id).then(function(post) {
    locals = {"adminSubtitle":"Manage post","post":helper.preparePost(post)};
    return viewEngine.respond('admin_post_images.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_post':'admin_post.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/post/:id/segments', function(req) {
  return couchdb.get(req.params.id).then(function(post) {
    ...
    return viewEngine.respond('admin_post_segments.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_segment':'admin_segment.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/post/:id/attachments', function(req) {
  return couchdb.get(req.params.id).then(function(post) {
    ...
    return viewEngine.respond('admin_post_attachments.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_post':'admin_post.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/post/:id/links', function(req) {
  return couchdb.get(req.params.id).then(function(post) {
    ...
    return viewEngine.respond('admin_post_links.html', {locals:locals,layout:"admin_layout.html",partials:{'admin_post':'admin_post.partial.html'}});
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
});
...
router.get('/admin/post/:id/preview', function(req) {
    return helper.config().then (function (config) {
        return couchdb.get(req.params.id).then(function(post) {
            ...
            return viewEngine.respond('admin_post_preview.html', {locals:locals,layout:"admin_layout.html",partials:{'post':'post.partial.html'}});
        });
    }, function (err) {
        return viewEngine.respond('posts.html', {locals:{"error":true,"message":"Unknown Error"}});
    });
...
router.post('/admin/config/images', function(req) {
    return couchdb.uploadMultipleFiles('config', [
        {'name':'background.jpg','content-type':'image/jpg','file':req.params.background_jpg}
...
router.get('/admin/post/:id/segments/add/:type/:num', function(req) {
    return couchdb.get(req.params.id).then(function(res) {
        var skel = "";
        switch(req.params.type) {
            ...
            case "html": skel={"html":""};
                         break;
            case "markdown": skel={"html":"", "markdown":""};
                         break;
            case "image": skel={"image":""};
                          break;
            case "thumbnails": skel={"thumbnails":[]};
                               break;
        }
        ...
        if (num == -1) {
            post["segments"].push(skel)
        } else {
            var segments = [];
            for (var i=0; i<num+1;i++) {
                segments.push(post['segments'][i]);
            }
            segments.push(skel);
            for (var i=num+1; i<post['segments'].length;i++) {
                segments.push(post['segments'][i]);
            }
            post["segments"]=segments;
        }
...
router.get('/admin/post/:id/segments/add/:type', function(req) {
    return bogart.redirect('/admin/post/'+req.params.id+'/segments/add/'+req.params.type+'/-1');
});
